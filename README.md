...
A book storage website.

["Book Store"] :- "Book Store" is a website for all fans of reading. It is a Single Page App (SPA) that allows users to:

- Add books.
- See their reading status.

In this project of the book store application. I set up the environment and tools needed to develop a React application.
...
```sh
cd my-folder
git clone https://github.com/Yidnekachew-cmd/book-store.git
```
### Install
...
- [ ] **[Adding_full_functionality_to_the_Storage]**
...
Feel free to check the [issues page](https://github.com/Yidnekachew-cmd/book-store/issues).
